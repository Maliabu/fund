...
export const _appFeatured = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
  title: ['Investor reporting', 'Onboarding', 'Investment product listing'][index],
  description: ['Send monthly reports using our already developed technology', 'Share a link and let people create accounts with your fund','List investment products online'][index],
